...
class DocumentController extends Controller
{
    ...
    public function updateStatusDocument($vendorId, Request $request)
    {
        $status = $request->status;

        $detailVendor = VendorDetail::where('vendor_id', $vendorId);
        $detailVendor->update([
            'document_status' => $status,
        ]);

        return redirect()->route('vendor.show', $request->vendorId)->with(['success' => 'Success To Update Status Document!']);
    }
}
